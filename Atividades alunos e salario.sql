...
FROM Alunos
WHERE Sexo = 'M' AND nome LIKE '%c%' AND nome NOT LIKE 'Heloisa Nunes%';


--Idade mínima do sexo feminino e do sexo masculino que têm a letra "f" no nome
SELECT MIN(Idade) AS Idade_minima
FROM Alunos
WHERE (Sexo = 'F' OR sexo = 'M') AND nome LIKE '%f%' AND nome NOT LIKE 'Heloisa Nunes%';


--dade máxima do sexo feminino (F) com nomes iniciados em "g"
SELECT MAX(Idade) AS Idade_maxima
FROM Alunos
WHERE Sexo = 'F' AND nome LIKE 'g%' AND nome NOT LIKE 'Heloisa Nunes%';


--Idade mínima dos sexo masculino com nomes iniciados em "r"
SELECT MIN(Idade) AS Idade_minima
FROM Alunos
WHERE sexo = 'M' AND nome LIKE 'r%' AND nome NOT LIKE 'Heloisa Nunes%';
...
SELECT *
FROM Alunos
WHERE sexo = 'F' AND nome LIKE '%a%' AND nome NOT LIKE 'Heloisa Nunes%';
